...
export async function initServiceAudit(){
  ...
  const tables=[
    ...
    'service_invoice_line_items','service_invoice_discounts','service_recurring_orders','service_recurring_order_items',
    'service_customer_orders','service_customer_order_items','service_order_change_log','service_order_product_catalog',
    'service_order_discount_codes','service_order_discounts'
  ];
