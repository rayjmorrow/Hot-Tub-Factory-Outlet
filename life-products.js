(()=>{
const products=[
{id:'life-ph-up-liquid',name:'1 pt pH Up Liquid',price:9.82,image:'ph-up-liquid.webp'},
{id:'life-brom-tabs-5',name:'5 lb Brominating Tabs',price:129.92,image:'brominating-tabs-5lb.webp'},
{id:'life-waterline-cleaner',name:'1 pt Waterline & Surface Cleaner',price:10.62,image:'waterline-surface-cleaner.webp'},
{id:'life-scale-defense',name:'1 pt Scale Defense',price:10.58,image:'scale-defense.webp'},
{id:'life-cover-cleaner',name:'1 pt Cover Cleaner & Conditioner',price:28.18,image:'cover-cleaner-conditioner.webp'},
{id:'life-scum-free',name:'1 pt Scum Free',price:10.84,image:'scum-free.webp'},
{id:'life-fresh-start',name:'Fresh Start Spa Maintenance Kit',price:65.64,image:'fresh-start-kit.webp'},
{id:'life-spasoft',name:'2 lbs SpaSoft',price:20.76,image:'spasoft-2lb.webp'},
{id:'life-chlor-5',name:'5 lb Chlorinating Granules',price:83.90,image:'chlorinating-granules-5lb.webp'},
{id:'life-foam-free',name:'1 pt Foam Free',price:10.84,image:'foam-free.webp'},
{id:'life-metal-out',name:'1 pt Metal Out',price:9.80,image:'metal-out.webp'},
{id:'life-filter-cleaner',name:'1 pt Filter Cleaner with Sprayer',price:14.46,image:'filter-cleaner-sprayer.webp'},
{id:'life-oxidizer-5',name:'5 lb Oxidizing Shock',price:60.94,image:'oxidizing-shock-5lb.webp'},
{id:'life-alk-up',name:'1 lb Alkalinity & pH Up',price:8.54,image:'alkalinity-ph-up.webp'},
{id:'life-calcium',name:'14 oz Calcium Booster',price:7.40,image:'calcium-booster.webp'},
{id:'life-brom-tabs-15',name:'1.5 lb Brominating Tabs',price:42.28,image:'brominating-tabs-1-5lb.webp'},
{id:'life-clarifier',name:'1 pt Natural Clarifier',price:8.58,image:'natural-clarifier.webp'},
{id:'life-oxidizer-15',name:'1.5 lb Oxidizing Shock',price:18.38,image:'oxidizing-shock-1-5lb.webp'},
{id:'life-chlor-2',name:'2 lb Chlorinating Granules',price:32.92,image:'chlorinating-granules-2lb.webp'},
{id:'life-alk-down',name:'1.5 lb Alkalinity & pH Down',price:10.40,image:'alkalinity-ph-down.webp'},
{id:'life-jet-cleaner',name:'1 pt Purge & Jet Line Cleaner',price:12.66,image:'purge-jet-line-cleaner.webp'}
];
